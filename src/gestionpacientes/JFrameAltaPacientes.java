...
public class JFrameAltaPacientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldApe1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextFieldApe1FocusLost(evt);
            }
        });

        jTextFieldApe2.setFont(new java.awt.Font("Cantarell", 0, 12)); // NOI18N
        jTextFieldApe2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextFieldApe2FocusLost(evt);
            }
        });
    ...
    /**
     * Llama a anadirPaciente(), abre la ventana Pacientes y cierra la actual
     * 
     * @param evt 
     */
    ...
    /**
     * Cambia el color de fondo del campo de texto dependiendo de si es correcto
     * o no el contenido
     * 
    ...
    /**
     * Comprueba si puede activar el boton Guardar
     * 
     * @param Evento de foco perdido
     */
